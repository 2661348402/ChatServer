...
public:
    ...
    // ---- Backgrounds ----
    static QString bgDialog() { return isDark() ? darkBgDialog : "#EDEDED"; }
    static QString bgChat() { return isDark() ? darkBgChat : "#F5F5F5"; }
    static QString bgInput() { return isDark() ? darkBgInput : "#F7F7F7"; }
    static QString bgCard() { return isDark() ? darkBgCard : "#FFFFFF"; }
    static QString bgTopBar() { return isDark() ? darkBgTopBar : "#F7F7F7"; }
    static QString bgHeader() { return isDark() ? darkBgHeader : "#F7F7F7"; }

    // ---- Borders ----

    static QString borderCard() { return isDark() ? darkBorderCard : "#E5E5E5"; }
    static QString borderInput() { return isDark() ? darkBorderInput : "#E5E5E5"; }
    static QString borderChat() { return isDark() ? darkBorderChat : "#E5E5E5"; }
    static QString borderBubble() { return isDark() ? darkBorderBubble : "#E5E5E5"; }
    static QString borderItem() { return isDark() ? darkBorderItem : "#EAEAEA"; }
    ...
    static QString hoverBg() { return isDark() ? darkHoverBg : "#EDEDED"; }
    static QString selectedBg() { return isDark() ? darkSelectedBg : "#DCDCDC"; }
